      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="fade-up bg-dark border border-amber p-8">
            ...
            <p className="text-ivory/80 text-[15px] whitespace-pre-line">{t("team.catarina.desc")}</p>
          </div>
          {/* Card 2 — Médica */}
          <div className="fade-up border border-bone p-8 bg-ivory">
            ...
            <p className="text-muted-custom text-[15px] whitespace-pre-line">{t("team.patricia.desc")}</p>
          </div>
          {/* Card 3 — Maya (AI) */}
          <div className="fade-up border border-bone p-8 bg-ivory">
            ...
            <p className="text-muted-custom text-[15px] whitespace-pre-line">{t("team.maya.desc")}</p>
          ...
          <div className="fade-up border border-bone p-8 bg-ivory">
            ...
            <p className="text-muted-custom text-[15px] whitespace-pre-line">{t("team.admin.desc")}</p>
          </div>
        </div>
      </div>
    </section>
