...
const translations: Record<string, Record<Language, string>> = {
  ...
  "blog.1.body": {
    pt: "Um dos padrões mais comuns que vejo na prática clínica: mulheres com meses ou anos de sintomas persistentes, análises dentro dos valores de referência, e sem respostas.\n\nO problema não está nos teus exames — está nos critérios que usamos para os interpretar.\n\nOs intervalos de referência convencionais foram definidos com base em populações gerais, que incluem pessoas já com disfunções subclínicas. Isto significa que podes ter valores \"normais\" e, ainda assim, estar longe do funcionamento óptimo.\n\nA medicina funcional utiliza critérios funcionais avançados — intervalos mais estreitos, baseados em fisiologia óptima e não apenas na ausência de doença.\n\nPor exemplo, uma TSH de 3.5 mUI/L é considerada \"normal\" pela maioria dos laboratórios. Mas funcionalmente, muitos especialistas consideram que valores acima de 2.0-2.5 já podem indicar uma tiróide sub-óptima — especialmente quando acompanhados de fadiga, queda de cabelo, aumento de peso ou nevoeiro mental.\n\nO mesmo aplica-se à ferritina, vitamina D, insulina em jejum, cortisol e muitos outros marcadores. Cada um deles tem um intervalo convencional e um intervalo funcional — e a diferença entre os dois pode ser a explicação para anos de sintomas sem resposta.\n\nSe os teus exames dizem que está tudo bem mas o teu corpo continua a dar sinais, talvez o problema não sejas tu. Talvez seja a lente através da qual estamos a olhar.",
    en: "One of the most common patterns I see in clinical practice: women with months or years of persistent symptoms, analyses within reference values, and no answers.\n\nThe problem isn't your tests — it's the criteria we use to interpret them.\n\nConventional reference ranges were defined based on general populations, which include people already with subclinical dysfunctions. This means you can have \"normal\" values and still be far from optimal functioning.\n\nFunctional medicine uses advanced functional criteria — narrower ranges, based on optimal physiology and not just the absence of disease.\n\nFor example, a TSH of 3.5 mIU/L is considered \"normal\" by most laboratories. But functionally, many specialists consider that values above 2.0-2.5 may already indicate a sub-optimal thyroid — especially when accompanied by fatigue, hair loss, weight gain, or brain fog.\n\nThe same applies to ferritin, vitamin D, fasting insulin, cortisol, and many other markers. Each has a conventional range and a functional range — and the difference between the two can explain years of unanswered symptoms.\n\nIf your tests say everything is fine but your body keeps sending signals, maybe the problem isn't you. Maybe it's the lens through which we're looking."
  },
  "blog.2.body": {
