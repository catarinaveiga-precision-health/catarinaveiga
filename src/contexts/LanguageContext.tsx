...
const translations: Record<string, Record<Language, string>> = {
  ...
  "team.catarina.desc": { pt: "Avalia\u00e7\u00e3o integrativa, interpreta\u00e7\u00e3o funcional avan\u00e7ada e coordena\u00e7\u00e3o de todo o acompanhamento. Mais de 20 anos de experi\u00eancia cl\u00ednica focada na sa\u00fade da mulher.", en: "Integrative assessment, advanced functional interpretation, and coordination of all follow-up. Over 20 years of clinical experience focused on women\u2019s health." },
  "team.patricia.role": { pt: "M\u00e9dica de Cl\u00ednica Geral", en: "General Practitioner" },
  "team.patricia.desc": { pt: "Consulta m\u00e9dica convencional quando indicada \u2014 medica\u00e7\u00e3o, exames ou referencia\u00e7\u00e3o para outras especialidades.", en: "Conventional medical consultation when indicated \u2014 medication, tests, or referral to other specialities." },
  "team.maya.role": { pt: "Agente AI de Nutri\u00e7\u00e3o Funcional", en: "AI Functional Nutrition Agent" },
  "team.maya.desc": { pt: "Apoio educativo e organizacional dispon\u00edvel entre consultas. Apoia na compreens\u00e3o do plano e nas d\u00favidas do dia a dia.", en: "Educational and organisational support available between consultations. Helps with understanding the plan and daily questions." },
  ...
  "team.va.badge": { pt: "Em breve", en: "Coming soon" },
  "team.va.title": { pt: "Assistente Virtual", en: "Virtual Assistant" },
  "team.va.role": { pt: "Apoio Administrativo", en: "Administrative Support" },
  "team.va.desc": { pt: "Apoio ao cliente e comunica\u00e7\u00e3o para garantir que a tua experi\u00eancia \u00e9 fluida, do primeiro contacto ao acompanhamento cont\u00ednuo.", en: "Client support and communication to ensure your experience is smooth, from first contact to ongoing follow-up." },
