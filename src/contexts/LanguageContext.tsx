...
const translations: Record<string, Record<Language, string>> = {
  ...
  "blog.1.title": { pt: "Exames normais não significam saúde", en: "Normal tests don't mean health" },
  "blog.1.intro": { pt: "Os teus exames estão normais. O teu corpo não concorda. A diferença entre valores de referência e valores ideais na medicina funcional.", en: "Your tests are normal. Your body disagrees. The difference between reference values and optimal values in functional medicine." },
  ...
  "blog.1.body": {
    pt: "## Valores de referência vs valores ideais na medicina funcional\n\nÉ uma das situações mais comuns na minha prática clínica.\n\nA pessoa chega cansada, com sintomas há meses ou anos — fadiga, queda de cabelo, ansiedade, dificuldade em emagrecer, alterações intestinais, dores, alterações do humor — e diz-me:\n\n> \"Os meus exames estão normais.\"\n\nE estão. Dentro dos **valores de referência**.\n\nO problema é que **valores de referência não foram desenhados para definir saúde**, muito menos saúde ótima.\n\n## O que são, afinal, valores de referência?\n\nOs valores de referência utilizados nos exames laboratoriais são **intervalos estatísticos**. São calculados a partir da média de uma população alargada — que inclui pessoas saudáveis, pessoas doentes, pessoas medicadas, inflamação silenciosa, défices nutricionais e alterações metabólicas não diagnosticadas.\n\nEm termos simples:\n\n- são intervalos que ajudam a identificar **doença instalada**\n- não foram criados para avaliar **funcionamento ótimo do organismo**\n- nem para detectar **desequilíbrios precoces**\n\nEstar dentro do intervalo de referência significa apenas: estatisticamente, não está fora da curva. Não significa que o corpo esteja regulado.\n\n## Porque é que os valores de referência falham na prática clínica?\n\nPorque o corpo **compensa durante muito tempo**. Antes de haver doença, há perda de eficiência, aumento da carga adaptativa, e alterações subtis nos sistemas hormonais, metabólicos, imunitários e neurológicos.\n\nOs sintomas aparecem **muito antes** de um marcador sair fora do intervalo.\n\n## Então o que são valores ideais?\n\nValores ideais são os intervalos onde sabemos, à luz da ciência atual e da fisiologia humana, que determinado sistema funciona de forma mais eficiente, com menor stress biológico e menor custo adaptativo. Não têm nada a ver com biohacking ou otimização artificial. Têm tudo a ver com **funcionamento humano normal**.\n\n## Exemplos que vemos todos os dias\n\n**Tiroide:** O intervalo de referência do TSH pode ir até valores superiores a 5. Clinicamente, uma pessoa pode ter fadiga, intolerância ao frio, dificuldade em emagrecer, ansiedade, queda de cabelo — e ouvir que a tiroide está \"normal\". Aqui, o problema não é o corpo. É o intervalo usado.\n\n**Vitamina D:** Valores de 20–30 ng/mL foram durante anos considerados aceitáveis. Hoje sabemos que não são protetores nem sustentam boa função imunitária.\n\n**Insulina:** A glicemia pode estar normal durante anos enquanto a insulina já está elevada — muito antes de surgir pré-diabetes. Quando olhamos apenas para valores de referência, chegamos tarde.\n\n## Se os seus exames estão \"normais\", mas não se sente bem…\n\nTalvez o problema não seja o seu corpo. Talvez seja o intervalo errado.\n\nNa medicina funcional, olhamos para valores ideais, contexto, história clínica, sintomas e fisiologia real.\n\n**Se quer uma avaliação completa, personalizada e baseada em ciência atual, pode marcar consulta.**\n\nPorque exames normais não significam, necessariamente, saúde.",
    en: "## Reference values vs optimal values in functional medicine\n\nIt's one of the most common situations in my clinical practice.\n\nThe person arrives tired, with symptoms for months or years — fatigue, hair loss, anxiety, difficulty losing weight, gut issues, pain, mood changes — and tells me:\n\n> \"My tests are normal.\"\n\nAnd they are. Within **reference values**.\n\nThe problem is that **reference values were not designed to define health**, let alone optimal health.\n\n## What are reference values, exactly?\n\nThe reference values used in lab tests are **statistical ranges**. They are calculated from the average of a broad population — which includes healthy people, sick people, medicated people, silent inflammation, nutritional deficiencies, and undiagnosed metabolic changes.\n\nIn simple terms:\n\n- they are ranges that help identify **established disease**\n- they were not created to evaluate **optimal body function**\n- nor to detect **early imbalances**\n\nBeing within the reference range only means: statistically, you're not an outlier. It doesn't mean your body is well regulated.\n\n## Why do reference values fail in clinical practice?\n\nBecause the body **compensates for a long time**. Before disease appears, there is loss of efficiency, increased adaptive load, and subtle changes in hormonal, metabolic, immune, and neurological systems.\n\nSymptoms appear **long before** a marker falls outside the range.\n\n## So what are optimal values?\n\nOptimal values are the ranges where we know, based on current science and human physiology, that a given system functions most efficiently, with less biological stress and lower adaptive cost. They have nothing to do with biohacking or artificial optimization. They have everything to do with **normal human function**.\n\n## Examples we see every day\n\n**Thyroid:** The TSH reference range can go up to values above 5. Clinically, a person can have fatigue, cold intolerance, difficulty losing weight, anxiety, hair loss — and hear that their thyroid is \"normal\". Here, the problem isn't the body. It's the range being used.\n\n**Vitamin D:** Values of 20–30 ng/mL were for years considered acceptable. Today we know they are not protective nor do they support good immune function.\n\n**Insulin:** Blood glucose can be normal for years while insulin is already elevated — long before pre-diabetes appears. When we only look at reference values, we arrive late.\n\n## If your tests are \"normal\" but you don't feel well…\n\nMaybe the problem isn't your body. Maybe it's the wrong range.\n\nIn functional medicine, we look at optimal values, context, clinical history, symptoms, and real physiology.\n\n**If you want a complete, personalized assessment based on current science, you can book a consultation.**\n\nBecause normal tests don't necessarily mean health."
  },
  "blog.2.body": {
