...
const translations: Record<string, Record<Language, string>> = {
  ...
  "team.patricia.role": { pt: "Médica · Inscrita na Ordem dos Médicos", en: "Physician · Registered with the Portuguese Medical Council" },
  "team.patricia.desc": { pt: "Responsável pela componente médica do acompanhamento: avaliação clínica, prescrição de medicação, pedidos de análises, diagnóstico clínico e referenciação. Privilegia decisões partilhadas e integra a dimensão física, mental e emocional.", en: "Responsible for the medical component of follow-up: clinical assessment, prescribing medication, ordering tests, clinical diagnosis, and referrals. Favours shared decisions and integrates physical, mental, and emotional dimensions." },
